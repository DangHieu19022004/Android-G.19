...
public class MentalTypeFragment extends Fragment {
    ...
    private List<BooksModel> mentalBookList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Initialize and populate mentalBookList
        initMentalBookList();

        // Initialize and set adapter for RecyclerView
        adapter = new BooksAdapter(getContext(), mentalBookList, new BooksAdapter.IClickListener() {
            @Override
