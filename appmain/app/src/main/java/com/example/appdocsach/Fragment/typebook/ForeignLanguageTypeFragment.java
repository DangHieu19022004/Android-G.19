...
public class ForeignLanguageTypeFragment extends Fragment {
    ...
    private List<BooksModel> languageBookList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Initialize and populate languageBookList
        initLanguageBookList();

        // Initialize and set adapter for RecyclerView
        adapter = new BooksAdapter(getContext(), languageBookList, new BooksAdapter.IClickListener() {
            @Override
